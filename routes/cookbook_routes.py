...
_HF_TOKEN_STATUS_SNIPPET = (
    ...
    'Add one in Atlas Settings -> Cookbook -> HuggingFace Token."; '
    'fi'
)
        ...
        if is_windows and remote:
            ...
            if "llama_cpp" in req.cmd or "llama-server" in req.cmd:
                ...
                if remote and _ollama_host in ("0.0.0.0", "::"):
                    runner_lines.append('echo "[odysseus] WARNING: remote Ollama will bind to ${ODYSSEUS_OLLAMA_HOST}:${ODYSSEUS_OLLAMA_PORT} so Atlas can reach it from this host."')
