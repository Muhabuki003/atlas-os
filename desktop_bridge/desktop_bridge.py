"""Atlas Desktop Bridge — Windows host service for safe desktop actions."""
...
LOG_PATH = Path(os.environ.get("ATLAS_BRIDGE_LOG", r"C:\AtlasWorkspace\Logs\desktop_bridge.log"))
DEFAULT_TOKEN = os.environ.get("ATLAS_BRIDGE_TOKEN", "")
DEFAULT_HOST_WORKSPACE = os.environ.get("ATLAS_BRIDGE_WORKSPACE", r"C:\AtlasWorkspace")
PORT = int(os.environ.get("ATLAS_BRIDGE_PORT", "8765"))

logger = logging.getLogger("atlas-desktop-bridge")
logging.basicConfig(level=logging.INFO, format="%(asctime)s %(levelname)s %(message)s")

app = FastAPI(title="Atlas Desktop Bridge", version="1.2")
...
def main():
    logger.info("Starting Atlas Desktop Bridge on 127.0.0.1:%s", PORT)
